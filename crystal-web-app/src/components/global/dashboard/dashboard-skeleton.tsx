 ...
 * including tabs, action buttons, folders, and video cards.
 * 
 * Purpose: Show loading placeholder for dashboard content
 * 
 * How it works:
 * 1. Displays skeleton for tab navigation
 * 2. Shows skeleton for action buttons
 ...
 * 
 * Features:
 * - Matches dashboard page layout structure
 * - Animated pulse effect for loading indication
 * - Responsive grid for video card skeletons
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-8 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="flex flex-col gap-3 rounded-xl border border-[#252525] p-4">
